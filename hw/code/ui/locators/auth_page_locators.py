...
class AuthPageLocators(BasePageLocators):
    ...
    # USE_PASSWORD_BUTTON = (By.XPATH, "//a[contains(text(),'Use password to sign in')]")
    # CLOSE_GUIDE_BUTTON = (By.XPATH, "//div[@tabindex='0' and @role='button' and @aria-label='Закрыть' and @class='vkuiModalDismissButton vkuiTappable vkuiInternalTappable vkuiTappable--hasHover vkuiTappable--hasActive vkui-focus-visible']")
    # OVERVIEW_BUTTON = (By.XPATH, "//a[@href='/hq/overview']")
    # CONFIRMATION = (By.XPATH,  "//*[@data-test-id='recaptcha-inter-next']")
