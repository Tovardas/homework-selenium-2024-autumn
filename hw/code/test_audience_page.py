...
class TestAudiencePage(BaseCase):
    ...
    def test_create_audience_modal_page_opened(self, audience_page, audience_page_verification):
        with allure.step("Нажать на кнопку 'Создать аудиторию' и проверить элементы окна"):
            audience_page.click_create_audience_button()
            audience_page_verification.check_create_audience_modal_elements()

    @allure.title("Закрытие модального окна создания аудитории")
    def test_create_audience_modal_page_closed(self, audience_page, audience_page_verification):
    ...
    def test_error_long_audience_name(self, audience_page, audience_page_verification):
        with allure.step("Ввести слишком длинное имя аудитории"):
            audience_page.click_create_audience_button()
            audience_page.enter_audience_name('мяу' * 255)
            audience_page_verification.check_error_message(audience_page.ERROR_TOO_LONG_AUDIENCE_NAME)

    @allure.title("Открытие модального окна для добавления источника")
    def test_add_source_modal_page_became_visible(self, audience_page, audience_page_verification):
        with allure.step("Открыть окно добавления источника"):
            audience_page.click_create_audience_button()
            audience_page.click_add_source_button()
            audience_page_verification.check_add_source_modal_elements()

    @allure.title("Создание и удаление аудитории")
    def test_create_and_delete_audience(self, audience_page, audience_page_verification):
        with allure.step("Создать аудиторию"):
            ...
            audience_page.click_modal_page_submit_button()
            audience_page_verification.check_audience_created(CUSTOM_AUDIENCE_NAME)

        with allure.step("Удалить аудиторию"):
            audience_page.hover_and_click_delete()
            audience_page.click_delete_confirm_button()
            audience_page_verification.check_audience_deleted()

    @allure.title("Поиск созданной аудитории")
    def test_try_to_find_audience_success(self, audience_page, audience_page_verification):
        ...
        with allure.step("Поиск по имени аудитории"):
            ...
            audience_page_verification.check_audience_item_visible()
    ...
    def test_try_to_find_audience_error(self, audience_page, audience_page_verification):
        with allure.step("Создание аудитории"):
            audience_page.click_create_audience_button()
            audience_page.click_add_source_button()
            audience_page.select_source(SOURCE_NAME)
        ...
        with allure.step("Поиск по несуществующему имени"):
            ...
            audience_page_verification.check_audience_item_invisible()
